...
const SEED = [
  // ── VISION ───────────────────────────────────────────────────────────────────
  {id:'v1',key:'V-0001',type:'vision',
   title:"To have an AI Enabled workforce and bring 40% operational efficiencies in product development",
   description:"By 2028 every product development team operates with AI-augmented workflows, resulting in a 40% reduction in time-to-market, a 40% reduction in manual effort, and measurable quality improvements across the full SDLC.",
   currentStatus:"Vision ratified by ExCo. AI Transformation Office established. Cross-functional steering group meets monthly.",
   currentStatusAt:"03 Mar 2025, 09:00",
   riskStatement:"Organisational change resistance and skills gaps at mid-management level could slow adoption. Dependency on a handful of key AI vendors creates concentration risk.",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Medium',impact:'40% operational efficiency gain across all product development units',
   owner:'CEO',startDate:'2024-01-01',endDate:'2028-12-31',progress:18,
   tags:['ai','transformation','efficiency'],
   links:['m1','m2','m3'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c1',text:'Vision formally endorsed at Q1 All-Hands. Employee pulse survey showing 78% awareness.',ts:'03 Mar 2025, 11:30'},
     {id:'c2',text:'Board approved the AI Transformation Charter. Budget allocation confirmed for FY2025.',ts:'15 Jan 2025, 14:00'},
   ]},

  // ── MISSIONS ─────────────────────────────────────────────────────────────────
  {id:'m1',key:'M-0001',type:'mission',
   title:"Embed AI tools and automation across every product development team",
   description:"Equip all engineers, QA analysts, product managers, and architects with AI-native tooling embedded directly in their daily workflows — from ideation and design through coding, testing and deployment.",
   currentStatus:"AI toolchain evaluation complete. GitHub Copilot and Cursor selected as primary coding assistants. Procurement in final stages.",
   currentStatusAt:"01 Mar 2025, 10:15",
   riskStatement:"Tool standardisation across diverse tech stacks may require bespoke integrations. License cost at scale may exceed initial budget estimates.",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Medium',impact:'Direct productivity gains across 600+ engineers and QA staff',
   owner:'CTO',startDate:'2024-06-01',endDate:'2027-12-31',progress:30,
   tags:['ai-tooling','engineering','automation'],
   links:['v1','g1','g2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c3',text:'Shortlist of 4 tools agreed with engineering leads. Pilot scope defined: 3 squads, 8 weeks.',ts:'25 Feb 2025, 16:00'},
   ]},

  {id:'m2',key:'M-0002',type:'mission',
   title:"Build a data-driven culture of continuous improvement powered by AI insights",
   description:"Harness AI-generated analytics, developer metrics, and operational telemetry to drive continuous process improvement — making data the default input to every planning and retrospective cycle.",
   currentStatus:"Developer metrics baseline established. AI-powered sprint analytics dashboard in UAT with 2 pilot teams.",
   currentStatusAt:"28 Feb 2025, 14:30",
   riskStatement:"Data quality and completeness issues in existing tooling may undermine AI insight accuracy. Teams may game metrics if measurement culture is not handled carefully.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'Faster feedback loops and evidence-based decision-making across all squads',
   owner:'CPO',startDate:'2024-09-01',endDate:'2027-12-31',progress:22,
   tags:['data','analytics','continuous-improvement'],
   links:['v1','g2','g3'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'m3',key:'M-0003',type:'mission',
   title:"Develop strategic AI partnerships to accelerate workforce and technology transformation",
   description:"Forge deep partnerships with leading AI platform vendors, research institutions, and specialist consultancies to access frontier capabilities, co-develop solutions, and fast-track workforce upskilling.",
   currentStatus:"Partnership framework agreed. MoU signed with two hyperscalers. University collaboration programme in scoping phase.",
   currentStatusAt:"20 Feb 2025, 09:45",
   riskStatement:"Over-reliance on a single hyperscaler could create lock-in. Partnership negotiations may slow if internal stakeholders are misaligned on requirements.",
   status:'In Progress',priority:'High',health:'Green',risk:'Low',impact:'Access to cutting-edge AI capabilities 12–18 months ahead of market availability',
   owner:'Chief Strategy Officer',startDate:'2024-06-01',endDate:'2028-12-31',progress:25,
   tags:['partnerships','vendors','ecosystem'],
   links:['v1','o3'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c4',text:'First joint AI lab workshop completed with Hyperscaler A. Three use cases identified for co-development.',ts:'18 Feb 2025, 17:00'},
   ]},

  // ── GOALS ────────────────────────────────────────────────────────────────────
  {id:'g1',key:'G-0001',type:'goal',
   title:"Reduce product development cycle time by 40% by end of 2027",
   description:"Through AI-assisted coding, automated code review, intelligent test generation, and AI-powered CI/CD, compress the average feature delivery cycle from idea to production by 40% vs the 2024 baseline.",
   currentStatus:"Baseline cycle time measured at 23 days average. Pilot teams using AI coding tools showing 15% improvement after 6 weeks.",
   currentStatusAt:"27 Feb 2025, 11:00",
   riskStatement:"Cycle time reduction may plateau if deployment and release governance processes are not modernised alongside development tooling.",
   status:'In Progress',priority:'Critical',health:'Amber',risk:'Medium',impact:'Faster time-to-market enabling competitive advantage and higher revenue velocity',
   owner:'VP Engineering',startDate:'2025-01-01',endDate:'2027-12-31',progress:15,
   tags:['cycle-time','velocity','sdlc'],
   links:['m1','o1','o2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'g2',key:'G-0002',type:'goal',
   title:"100% of product teams AI-proficient with certified skills by Q4 2026",
   description:"Every engineer, QA analyst, product manager, and delivery lead completes a structured AI proficiency pathway and holds a recognised certification — ensuring the workforce transformation is deep and durable, not superficial.",
   currentStatus:"Skills taxonomy defined. Learning pathway designed across 3 tiers: Foundations, Practitioner, Advanced. LMS integration in progress.",
   currentStatusAt:"01 Mar 2025, 09:30",
   riskStatement:"High attrition in tech roles could mean significant re-training overhead. Employees who feel threatened by AI may disengage from the programme.",
   status:'In Progress',priority:'High',health:'Green',risk:'Medium',impact:'Sustainable AI capability embedded in the organisation rather than dependent on a few individuals',
   owner:'Chief People Officer',startDate:'2025-01-01',endDate:'2026-12-31',progress:20,
   tags:['upskilling','certification','workforce'],
   links:['m1','m2','o3'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'g3',key:'G-0003',type:'goal',
   title:"Reduce manual testing effort by 60% through AI-driven QA automation by 2027",
   description:"Eliminate repetitive manual regression testing, exploratory scripting, and test data preparation through AI-generated test suites, self-healing test automation, and intelligent defect triage — freeing QA teams for high-value exploratory and UX testing.",
   currentStatus:"AI test generation tool selected (Diffblue Cover for unit, Testim for UI). PoC completed on Payments squad: 48% manual effort reduction achieved.",
   currentStatusAt:"02 Mar 2025, 15:00",
   riskStatement:"Legacy applications with no test coverage baseline are difficult to onboard to AI testing tools. PoC results may not fully generalise to complex enterprise modules.",
   status:'In Progress',priority:'High',health:'Green',risk:'Medium',impact:'60% reduction in QA manual hours; faster regression cycles; higher defect detection rate',
   owner:'Head of Quality Engineering',startDate:'2025-01-01',endDate:'2027-06-30',progress:28,
   tags:['qa','automation','testing'],
   links:['m2','o2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c5',text:'PoC results presented to QE leadership. Green light to proceed to scaled pilot across 5 squads.',ts:'28 Feb 2025, 16:30'},
   ]},

  // ── OKRs ─────────────────────────────────────────────────────────────────────
  {id:'o1',key:'O-0001',type:'okr',
   title:"Increase developer productivity by 40% using AI coding assistants by Q4 2026",
   description:"Deploy AI coding assistants to all engineers and measure impact on output quality and velocity through rigorous before/after instrumentation.",
   currentStatus:"KR1: 22% productivity gain measured on pilot cohort (target 40%). KR2: 94 engineers onboarded (target 600). KR3: Code review cycle 18% faster.",
   currentStatusAt:"03 Mar 2025, 09:00",
   riskStatement:"Measurement methodology for 'productivity' is contested — lines of code is a poor proxy. Need to validate composite scoring model with engineering leadership.",
   keyResult:"KR1: 40% productivity gain (composite score) across all engineers by Q4 2026\nKR2: 600 engineers actively using AI coding assistant daily by Q2 2026\nKR3: 30% reduction in code review turnaround time\nKR4: AI-assisted PR acceptance rate ≥ 85%",
   status:'In Progress',priority:'Critical',health:'Amber',risk:'Medium',impact:'40% developer productivity uplift compounding across all product squads',
   owner:'CTO',startDate:'2025-01-01',endDate:'2026-12-31',progress:22,
   tags:['developer-productivity','copilot','ai-coding'],
   links:['g1','i1'],dependencies:[],attachments:[],
   comments:[]},

  {id:'o2',key:'O-0002',type:'okr',
   title:"Deploy AI-powered QA platform across all product squads by Q2 2026",
   description:"Roll out AI-generated test suites, self-healing automation, and intelligent defect triage to every product squad, achieving measurable reduction in manual testing hours and escaped defects.",
   currentStatus:"KR1: 5 squads onboarded (target 28). KR2: 48% manual effort reduction on pilot (target 60%). KR3: Defect escape rate reduced 12% (target 30%).",
   currentStatusAt:"28 Feb 2025, 17:00",
   riskStatement:"Squads with legacy monolithic applications may require significant refactoring before AI test tools can be applied effectively.",
   keyResult:"KR1: All 28 product squads onboarded to AI QA platform by Q2 2026\nKR2: 60% reduction in manual QA effort per sprint\nKR3: 30% reduction in production defect escape rate\nKR4: Average regression suite execution time under 15 minutes",
   status:'In Progress',priority:'High',health:'Green',risk:'Medium',impact:'Faster, higher-quality releases with significantly reduced manual QA overhead',
   owner:'Head of Quality Engineering',startDate:'2025-03-01',endDate:'2026-06-30',progress:18,
   tags:['qa-automation','testing','ai-platform'],
   links:['g1','g3','i2'],dependencies:[],attachments:[],
   comments:[]},

  {id:'o3',key:'O-0003',type:'okr',
   title:"Train and certify 500 product team members on AI tools by Q3 2026",
   description:"Deliver a structured, tiered AI proficiency programme resulting in 500 certified practitioners across engineering, QA, and product management by Q3 2026.",
   currentStatus:"KR1: 87 certifications issued (target 500). KR2: Foundations module live, Practitioner module in final review. KR3: NPS of training: 72.",
   currentStatusAt:"01 Mar 2025, 14:00",
   riskStatement:"Competing delivery pressures may reduce team members' availability for training. Without manager sponsorship, voluntary participation rates may fall short.",
   keyResult:"KR1: 500 certified AI practitioners by Q3 2026 (currently 87)\nKR2: All 3 training tiers (Foundations, Practitioner, Advanced) live by Q1 2026\nKR3: Training NPS ≥ 70 (currently 72)\nKR4: 90% of managers complete AI leadership module",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'Deep, durable AI capability across the entire product workforce',
   owner:'Chief People Officer',startDate:'2025-01-01',endDate:'2026-09-30',progress:17,
   tags:['training','certification','upskilling'],
   links:['g2','m3','i3'],dependencies:[],attachments:[],
   comments:[]},

  // ── KEY RESULTS ──────────────────────────────────────────────────────────────
  {id:'kr1',key:'KR-0001',type:'kr',
   title:"40% productivity gain (composite score) across all 600 engineers by Q4 2026",
   description:"Measure using a composite scoring model combining PR throughput, story point velocity, code review cycle time, and AI tool adoption rate. Baseline established Q1 2025.",
   currentStatus:"Pilot cohort of 94 engineers showing 22% gain. Composite model validated with engineering leadership. Full rollout tracking dashboard live.",
   currentStatusAt:"03 Mar 2025, 09:00",
   keyResult:"Baseline: 0% (Q1 2025)\nCurrent: 22% (pilot cohort of 94 engineers)\nTarget: 40% across 600 engineers by Q4 2026\nMeasurement: Composite score — PR throughput, velocity, review cycle time",
   status:'In Progress',priority:'Critical',health:'Amber',risk:'Medium',impact:'Foundational metric for the AI developer productivity OKR',
   owner:'CTO',assigned:'VP Engineering',sponsor:'',businessUnit:'Engineering',
   approvedBudget:'',actualCost:'',
   startDate:'2025-01-01',endDate:'2026-12-31',progress:22,
   impactType:'Revenue',impact:'40% productivity gain compounding across all product squads',
   tags:['productivity','measurement','ai-coding'],
   links:['o1'],dependencies:[],attachments:[],
   comments:[],updatedAt:'03 Mar 2025, 09:00',updatedBy:'RB'},

  {id:'kr2',key:'KR-0002',type:'kr',
   title:"600 engineers actively using AI coding assistant daily by Q2 2026",
   description:"Track daily active usage via telemetry from GitHub Copilot Business and Cursor. Target: ≥90% of the 600-engineer cohort using the tool on any given working day.",
   currentStatus:"94 engineers in pilot, daily active rate 88%. Enterprise licensing agreed for 600 seats. SSO integration complete. Broad rollout commences Q2 2025.",
   currentStatusAt:"28 Feb 2025, 17:00",
   keyResult:"Baseline: 94 engineers (pilot)\nCurrent: 94 / 600 engineers onboarded (16%)\nTarget: 600 engineers, ≥90% daily active usage by Q2 2026\nMeasurement: Telemetry — daily active users / total licensed seats",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Low',impact:'Prerequisite for achieving the 40% productivity gain KR',
   owner:'VP Engineering',assigned:'Engineering Transformation Lead',sponsor:'',businessUnit:'Engineering',
   approvedBudget:'',actualCost:'',
   startDate:'2025-02-01',endDate:'2026-06-30',progress:16,
   impactType:'Revenue',impact:'600 engineers with AI coding assistance drives the productivity OKR',
   tags:['copilot','adoption','rollout'],
   links:['o1','i1'],dependencies:['kr1'],attachments:[],
   comments:[],updatedAt:'28 Feb 2025, 17:00',updatedBy:'RB'},

  {id:'kr3',key:'KR-0003',type:'kr',
   title:"500 certified AI practitioners across engineering, QA and product by Q3 2026",
   description:"Issue formal AI practitioner certificates across three tiers — Foundations (all staff), Practitioner (engineers and QAs), Advanced (leads and architects). Tracked in the LMS.",
   currentStatus:"87 Foundations certifications issued. Practitioner module in final content review. NPS of completed training: 72 (target ≥70 — already met).",
   currentStatusAt:"01 Mar 2025, 14:00",
   keyResult:"Baseline: 0 certificates (Q4 2024)\nCurrent: 87 Foundations certificates issued\nTarget: 500 certified practitioners (all 3 tiers) by Q3 2026\nMeasurement: LMS certificate records",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'Builds durable AI capability across the product workforce',
   owner:'Chief People Officer',assigned:'L&D Director',sponsor:'',businessUnit:'People & Culture',
   approvedBudget:'',actualCost:'',
   startDate:'2025-01-01',endDate:'2026-09-30',progress:17,
   impactType:'Risk Mitigation',impact:'AI skill gap closure across 500 practitioners',
   tags:['certification','training','upskilling'],
   links:['o3'],dependencies:[],attachments:[],
   comments:[],updatedAt:'01 Mar 2025, 14:00',updatedBy:'RB'},

  // ── INITIATIVES ───────────────────────────────────────────────────────────────
  {id:'i1',key:'I-0001',type:'initiative',
   title:"AI Developer Toolchain Programme",
   description:"Select, procure, integrate and roll out a unified AI developer toolchain (coding assistants, AI code review, AI-assisted architecture tooling) across all engineering squads globally.",
   currentStatus:"Tool selection complete. Enterprise licensing agreed for GitHub Copilot Business. SSO integration with internal IdP in progress. Pilot cohort of 100 engineers starts 17 Mar.",
   currentStatusAt:"04 Mar 2025, 10:00",
   riskStatement:"Inconsistent IDE adoption across teams (VS Code, IntelliJ, Vim) may require multiple integration paths. Security review of AI tool data handling is on critical path.",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Medium',impact:'Foundation for all AI productivity gains across the engineering workforce',
   owner:'VP Engineering',startDate:'2025-01-01',endDate:'2026-06-30',progress:32,
   tags:['toolchain','copilot','developer-experience'],
   links:['o1','p1','p2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c6',text:'Security review of GitHub Copilot data residency completed. Approved for use with code-exclusion policy applied.',ts:'03 Mar 2025, 14:30'},
   ]},

  {id:'i2',key:'I-0002',type:'initiative',
   title:"Intelligent QA Automation Initiative",
   description:"Implement an AI-powered quality engineering platform across all product squads — covering AI test generation, self-healing test automation, intelligent defect triage, and predictive release quality scoring.",
   currentStatus:"PoC validated. Platform architecture approved. Vendor contracts signed. Scaled pilot with 8 squads begins Q2 2025.",
   currentStatusAt:"02 Mar 2025, 16:00",
   riskStatement:"Self-healing automation tools require periodic re-training as UIs change — ongoing maintenance effort may be underestimated. Integration with legacy test management tools needs careful scoping.",
   status:'In Progress',priority:'High',health:'Green',risk:'Medium',impact:'60% reduction in manual QA effort; 30% fewer production defects',
   owner:'Head of Quality Engineering',startDate:'2025-03-01',endDate:'2026-09-30',progress:25,
   tags:['qa','automation','ai-testing'],
   links:['o2','p3'],dependencies:['i1'],attachments:[],keyResult:'',
   comments:[]},

  {id:'i3',key:'I-0003',type:'initiative',
   title:"AI Workforce Upskilling Academy",
   description:"Design and deliver a comprehensive, role-based AI upskilling programme through a dedicated internal academy — blending e-learning, hands-on labs, mentoring, and externally recognised certification.",
   currentStatus:"Academy branding and LMS configuration complete. Foundations module (Module 1 of 3) launched with 210 enrolees. Practitioner module content in final QA.",
   currentStatusAt:"03 Mar 2025, 09:30",
   riskStatement:"Content may become outdated quickly given the pace of AI tool evolution — requires a robust content refresh cycle. External certification partner alignment is still in negotiation.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'500 certified AI practitioners; sustainable internal capability independent of external hires',
   owner:'Chief People Officer',startDate:'2025-01-01',endDate:'2026-09-30',progress:20,
   tags:['academy','learning','certification'],
   links:['o3','p4'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  // ── PROGRAMS ──────────────────────────────────────────────────────────────────
  {id:'p1',key:'PR-0001',type:'program',
   title:"GitHub Copilot Enterprise Rollout Program",
   description:"Manage the end-to-end rollout of GitHub Copilot Business to all 600 engineers — covering procurement, security configuration, IDE integration, onboarding training, and adoption measurement.",
   currentStatus:"Phase 1 (100-engineer pilot) underway. Week 2 adoption metrics: 89% daily active usage. Productivity baseline data being collected.",
   currentStatusAt:"04 Mar 2025, 11:00",
   riskStatement:"Pilot engineers may 'over-accept' AI suggestions without review, creating technical debt. Strong code review culture must be reinforced alongside tool rollout.",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Medium',impact:'AI coding assistance for 600 engineers; foundational to 40% productivity OKR',
   owner:'Engineering Transformation Lead',startDate:'2025-02-01',endDate:'2025-12-31',progress:30,
   tags:['copilot','rollout','engineering'],
   links:['i1','pj1','pj2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c7',text:'Phase 1 kick-off completed. All 100 pilot engineers have active licences and completed onboarding session.',ts:'17 Feb 2025, 17:00'},
   ]},

  {id:'p2',key:'PR-0002',type:'program',
   title:"AI Code Review & Architecture Assistant Program",
   description:"Deploy AI-assisted code review tooling (CodeRabbit, SonarQube AI) and architecture decision support tools to all senior engineers and architects, reducing review bottlenecks and improving design consistency.",
   currentStatus:"CodeRabbit integrated with GitHub. Pilot with 3 squads: average PR review time reduced from 4.2 hours to 2.7 hours. Architecture assistant tool selection in progress.",
   currentStatusAt:"28 Feb 2025, 15:30",
   riskStatement:"Engineers may feel their expertise is undermined by AI review tools, causing friction. Clear positioning as 'AI as reviewer assistant, not replacement' is essential.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'30% reduction in PR review cycle time; improved code quality consistency across squads',
   owner:'Principal Engineer',startDate:'2025-02-01',endDate:'2025-12-31',progress:35,
   tags:['code-review','architecture','ai-tools'],
   links:['i1','pj3'],dependencies:['p1'],attachments:[],keyResult:'',
   comments:[]},

  {id:'p3',key:'PR-0003',type:'program',
   title:"AI Test Generation & Self-Healing Automation Program",
   description:"Roll out Diffblue Cover (unit test generation), Testim (UI automation), and Mabl (self-healing E2E tests) across all 28 product squads, replacing manual scripted test creation with AI-generated coverage.",
   currentStatus:"Scaled pilot across 8 squads in progress. Average unit test coverage increased from 42% to 67% on pilot squads. Self-healing automation reducing flaky test failures by 34%.",
   currentStatusAt:"03 Mar 2025, 10:30",
   riskStatement:"Squads with very low existing coverage face a steeper onboarding curve. Conflicting testing frameworks across squads (pytest, JUnit, Mocha) require tool configuration overhead.",
   status:'In Progress',priority:'High',health:'Green',risk:'Medium',impact:'Elimination of 60% manual testing effort; faster regression cycles; higher confidence in releases',
   owner:'QE Platform Lead',startDate:'2025-03-01',endDate:'2026-06-30',progress:28,
   tags:['test-automation','ai-qa','diffblue','testim'],
   links:['i2','pj4','pj5'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'p4',key:'PR-0004',type:'program',
   title:"AI Academy Learning Program",
   description:"Operate and scale the internal AI Academy — managing content, cohort scheduling, external certification partnerships, mentoring, and outcomes tracking across all three tiers of the AI proficiency pathway.",
   currentStatus:"Module 1 (Foundations) live with 210 active learners. Completion rate 68% in week 3. Module 2 (Practitioner) content finalised; due to launch 01 Apr.",
   currentStatusAt:"03 Mar 2025, 09:00",
   riskStatement:"Content currency risk: AI tooling is evolving faster than the production cycle for e-learning. A rapid-update content process must be established alongside the main programme.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'500 certified AI practitioners by Q3 2026',
   owner:'L&D Director',startDate:'2025-01-01',endDate:'2026-09-30',progress:20,
   tags:['academy','elearning','certification'],
   links:['i3','pj6'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  // ── PROJECTS ──────────────────────────────────────────────────────────────────
  {id:'pj1',key:'PJ-0001',type:'project',
   title:"Copilot Pilot — Phase 1 (100 Engineers)",
   description:"Run an 8-week controlled pilot of GitHub Copilot Business with 100 volunteer engineers across 10 squads. Measure productivity, code quality, developer satisfaction, and security compliance.",
   currentStatus:"Week 3 of 8. Daily active usage: 89%. Productivity composite score up 17% vs baseline. No security incidents. Satisfaction NPS: 74.",
   currentStatusAt:"04 Mar 2025, 08:30",
   riskStatement:"Small sample size may not represent complex/legacy codebases. Results must be validated against a control group to isolate Copilot effect from other factors.",
   status:'In Progress',priority:'Critical',health:'Green',risk:'Low',impact:'Validated evidence base for full 600-engineer rollout decision',
   owner:'Engineering Transformation Lead',startDate:'2025-02-17',endDate:'2025-04-11',progress:37,
   tags:['pilot','copilot','phase-1'],
   links:['p1','t1','t2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c8',text:'Week 2 metrics shared with CTO. Green light to continue. Full rollout plan to be submitted after Week 6 review.',ts:'28 Feb 2025, 17:00'},
   ]},

  {id:'pj2',key:'PJ-0002',type:'project',
   title:"Copilot Enterprise Licence & Security Configuration",
   description:"Procure and configure GitHub Copilot Business enterprise licences for 600 engineers — including SSO integration, code-exclusion policies, data residency configuration, and integration with existing GitHub Enterprise.",
   currentStatus:"600-seat licence agreement signed. SSO integration with Azure AD complete. Code-exclusion policy (proprietary algorithms) configured and verified. IDE plugin deployment via MDM in staging.",
   currentStatusAt:"03 Mar 2025, 14:00",
   riskStatement:"MDM deployment of IDE plugins may fail on developer-managed machines. Manual installation fallback will be needed for 15–20% of the fleet.",
   status:'In Progress',priority:'High',health:'Green',risk:'Low',impact:'Secure, compliant foundation for Copilot deployment to all 600 engineers',
   owner:'Platform Security Lead',startDate:'2025-01-15',endDate:'2025-03-31',progress:80,
   tags:['licensing','security','configuration'],
   links:['p1','t3'],dependencies:[],attachments:[{name:'Copilot Security Assessment.pdf',size:'1.8 MB',ext:'pdf',uploadedAt:'2025-02-10'}],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'pj3',key:'PJ-0003',type:'project',
   title:"CodeRabbit AI Code Review Integration",
   description:"Integrate CodeRabbit AI code reviewer into all GitHub repositories across the organisation — configuring review profiles per squad, tuning sensitivity settings, and establishing feedback loops for continuous improvement.",
   currentStatus:"Integrated into 12 of 28 squad repositories. Average PR review time reduced from 4.2h to 2.7h on integrated squads. Rollout to remaining 16 squads planned for Mar–Apr.",
   currentStatusAt:"02 Mar 2025, 16:30",
   riskStatement:"Squads with complex domain logic report some irrelevant AI suggestions — configuration profiles need domain-specific tuning which adds overhead per squad.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'30% reduction in PR review cycle time organisation-wide',
   owner:'DevEx Lead',startDate:'2025-02-01',endDate:'2025-05-31',progress:43,
   tags:['code-review','coderabbit','github'],
   links:['p2','t4'],dependencies:['pj2'],attachments:[],keyResult:'',
   comments:[]},

  {id:'pj4',key:'PJ-0004',type:'project',
   title:"AI Unit Test Generation — Diffblue Cover Rollout",
   description:"Deploy Diffblue Cover to auto-generate unit tests for Java and Python codebases across all product squads, targeting 80% unit test coverage on all new and modified code.",
   currentStatus:"Deployed to 8 pilot squads. Coverage uplift: 42% → 67% on pilot codebases. Java integration stable; Python integration still in beta — known issues with async functions.",
   currentStatusAt:"03 Mar 2025, 10:00",
   riskStatement:"Python async code support is immature in current Diffblue version. Squads with Python-heavy codebases may need to use alternative tools or wait for next release.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'Significant reduction in time spent writing unit tests; higher baseline coverage across all codebases',
   owner:'QE Platform Lead',startDate:'2025-03-01',endDate:'2025-09-30',progress:28,
   tags:['unit-tests','diffblue','java','python'],
   links:['p3','t5'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'pj5',key:'PJ-0005',type:'project',
   title:"Self-Healing UI Test Automation — Testim Rollout",
   description:"Replace brittle Selenium-based UI test scripts with Testim AI-powered self-healing test automation across all product squads — eliminating flaky tests and reducing maintenance overhead.",
   currentStatus:"Testim deployed to 5 squads. Flaky test failure rate reduced from 23% to 8% on migrated suites. Selenium migration effort higher than estimated — revising timeline.",
   currentStatusAt:"02 Mar 2025, 14:30",
   riskStatement:"Selenium-to-Testim migration is more effort-intensive than estimated for complex test suites. May require dedicated migration sprints, delaying other squad priorities.",
   status:'On Hold',priority:'Medium',health:'Amber',risk:'High',impact:'Elimination of flaky test failures; 40% reduction in UI test maintenance overhead',
   owner:'Senior QE Engineer',startDate:'2025-03-01',endDate:'2025-12-31',progress:18,
   tags:['ui-testing','testim','self-healing'],
   links:['p3','t6'],dependencies:['pj4'],attachments:[],keyResult:'',
   comments:[
     {id:'c9',text:'Timeline revised. Dedicated migration squad of 2 QEs to be formed. New target: all squads by Q4 2025.',ts:'01 Mar 2025, 15:00'},
   ]},

  {id:'pj6',key:'PJ-0006',type:'project',
   title:"AI Foundations Training Module — Design & Launch",
   description:"Design, build, and launch Module 1 (Foundations) of the AI Academy — covering AI literacy, responsible AI use, overview of AI coding and QA tools, and hands-on labs in a sandboxed environment.",
   currentStatus:"Module live since 10 Feb. 210 enrolees, 68% completion rate. Average satisfaction score 4.3/5. Most frequent feedback: labs too short — extending in v1.1 update.",
   currentStatusAt:"03 Mar 2025, 08:00",
   riskStatement:"Content accuracy depends on rapid editorial review cycles. Two SMEs who authored the content have since changed roles — knowledge transfer to new reviewers essential.",
   status:'In Progress',priority:'High',health:'Green',risk:'Low',impact:'AI literacy baseline established for all 600 product team members',
   owner:'L&D Director',startDate:'2024-11-01',endDate:'2025-04-30',progress:65,
   tags:['foundations','elearning','module-1'],
   links:['p4','t7','t8'],dependencies:[],attachments:[{name:'AI Foundations Curriculum v2.pdf',size:'3.1 MB',ext:'pdf',uploadedAt:'2025-01-20'}],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  // ── TASKS ─────────────────────────────────────────────────────────────────────
  {id:'t1',key:'T-0001',type:'task',
   title:"Instrument productivity baseline metrics for Copilot pilot cohort",
   description:"Set up measurement instrumentation across 10 pilot squads — capturing PR throughput, review cycle time, build success rate, and developer-reported effort per story point before and during the pilot.",
   currentStatus:"Baseline data captured for all 100 pilot engineers. Dashboard live in Grafana. Week-on-week comparison automated.",
   currentStatusAt:"17 Feb 2025, 17:00",
   riskStatement:"Metric gaming risk: engineers aware of being measured may behave differently. Blind baselining period should be considered for future cohorts.",
   status:'Completed',priority:'High',health:'Green',risk:'Low',impact:'Rigorous measurement foundation for Copilot business case',
   owner:'Data Engineer',startDate:'2025-02-10',endDate:'2025-02-17',progress:100,
   tags:['metrics','baseline','measurement'],
   links:['pj1','st1','st2'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'t2',key:'T-0002',type:'task',
   title:"Conduct weekly pilot check-in and feedback sessions",
   description:"Facilitate structured weekly check-ins with pilot engineer cohort leads — collecting qualitative feedback on tool usefulness, blockers, and emerging use patterns. Synthesise into weekly progress report.",
   currentStatus:"3 of 8 weekly sessions completed. Key themes: engineers love autocomplete; mixed views on test generation quality; strong demand for prompt engineering training.",
   currentStatusAt:"03 Mar 2025, 09:00",
   riskStatement:"If feedback loops are not actioned quickly, pilot participants may disengage. Must demonstrate that feedback is heard and changes are made.",
   status:'In Progress',priority:'Medium',health:'Green',risk:'Low',impact:'Real-time course correction for pilot; qualitative evidence to complement metrics',
   owner:'Engineering Transformation Lead',startDate:'2025-02-17',endDate:'2025-04-11',progress:37,
   tags:['feedback','pilot','engagement'],
   links:['pj1','st3'],dependencies:['t1'],attachments:[],keyResult:'',
   comments:[]},

  {id:'t3',key:'T-0003',type:'task',
   title:"Configure code-exclusion policies and data residency for Copilot",
   description:"Implement and verify GitHub Copilot code-exclusion policies to prevent proprietary algorithm files from being transmitted to GitHub's AI model. Configure EU data residency for GDPR compliance.",
   currentStatus:"Code-exclusion policies applied to all 47 repositories containing proprietary code. EU data residency verified by security team. Compliance sign-off received.",
   currentStatusAt:"10 Feb 2025, 14:00",
   riskStatement:"New repositories created after policy configuration may not automatically inherit exclusion rules. Automated policy inheritance check required.",
   status:'Completed',priority:'Critical',health:'Green',risk:'Low',impact:'GDPR-compliant, secure Copilot deployment protecting all proprietary IP',
   owner:'Platform Security Lead',startDate:'2025-01-15',endDate:'2025-02-10',progress:100,
   tags:['security','gdpr','configuration'],
   links:['pj2','st4'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c10',text:'DPO sign-off received on data residency configuration. Cleared for full rollout.',ts:'10 Feb 2025, 16:00'},
   ]},

  {id:'t4',key:'T-0004',type:'task',
   title:"Configure and tune CodeRabbit review profiles per squad",
   description:"Create and tune CodeRabbit review configuration profiles for each squad — setting appropriate sensitivity, language rules, domain-specific patterns, and integration with existing PR workflows.",
   currentStatus:"12 of 28 squad profiles configured. Remaining 16 squads scheduled for Mar–Apr. Average tuning time per squad: 3 hours.",
   currentStatusAt:"02 Mar 2025, 15:00",
   riskStatement:"Squads are diverse in tech stack and coding conventions — generic profiles generate too much noise. Each squad needs bespoke configuration, which is time-intensive.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'High signal-to-noise AI code review across all squads',
   owner:'DevEx Lead',startDate:'2025-02-01',endDate:'2025-04-30',progress:43,
   tags:['coderabbit','configuration','devex'],
   links:['pj3','st5'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'t5',key:'T-0005',type:'task',
   title:"Onboard 8 pilot squads to Diffblue Cover and validate output quality",
   description:"Walk 8 squads through Diffblue Cover installation, configuration, and first-run test generation. Review AI-generated test quality with squad leads and iterate on configuration settings.",
   currentStatus:"All 8 squads onboarded. Java squads report high-quality outputs. Python async issues documented and escalated to Diffblue support — workaround applied.",
   currentStatusAt:"03 Mar 2025, 10:00",
   riskStatement:"Diffblue Python async limitations require manual workaround that adds effort. If not resolved in upcoming release, Python squads will need alternative tooling.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'8 squads producing AI-generated unit tests; coverage uplift 42% → 67%',
   owner:'QE Platform Lead',startDate:'2025-03-01',endDate:'2025-04-15',progress:60,
   tags:['diffblue','onboarding','unit-tests'],
   links:['pj4','st6'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'t6',key:'T-0006',type:'task',
   title:"Migrate 3 priority squads from Selenium to Testim",
   description:"Lead the migration of Checkout, Payments, and User Identity squads from Selenium to Testim self-healing automation — including script conversion, Testim configuration, and team training.",
   currentStatus:"Checkout squad migration complete (340 scripts migrated). Payments squad in progress (180/410 scripts). Identity squad migration starting next sprint.",
   currentStatusAt:"01 Mar 2025, 16:00",
   riskStatement:"Payments squad has highly dynamic UI elements that challenge Testim's self-healing. Manual fallbacks may be needed for 15–20% of Payments tests.",
   status:'On Hold',priority:'Medium',health:'Amber',risk:'High',impact:'Elimination of Selenium flakiness for 3 highest-traffic product squads',
   owner:'Senior QE Engineer',startDate:'2025-03-01',endDate:'2025-06-30',progress:25,
   tags:['selenium','testim','migration'],
   links:['pj5','st7'],dependencies:['t5'],attachments:[],keyResult:'',
   comments:[]},

  {id:'t7',key:'T-0007',type:'task',
   title:"Develop and publish AI Foundations e-learning modules (3 units)",
   description:"Author, review, and publish the three learning units of AI Foundations: Unit 1 — AI Literacy & Concepts; Unit 2 — Responsible & Safe AI Use; Unit 3 — AI Tools Orientation (Copilot, QA tools, analytics).",
   currentStatus:"All 3 units published. Unit 3 receiving most positive feedback. Unit 2 (Responsible AI) flagged for deeper content on hallucination risks — v1.1 update in authoring.",
   currentStatusAt:"03 Mar 2025, 07:45",
   riskStatement:"Responsible AI unit content must reflect the organisation's actual AI policy — requires legal and compliance review on each update cycle.",
   status:'In Progress',priority:'High',health:'Green',risk:'Low',impact:'210 learners progressing through structured AI literacy content',
   owner:'L&D Content Lead',startDate:'2024-11-01',endDate:'2025-03-31',progress:85,
   tags:['content','elearning','ai-literacy'],
   links:['pj6','st8'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'t8',key:'T-0008',type:'task',
   title:"Build and launch sandboxed AI lab environment for Foundations learners",
   description:"Provision a sandboxed cloud lab environment where Foundations learners can interact with AI coding tools, QA tools, and analytics dashboards in a safe, non-production context.",
   currentStatus:"Lab environment live on AWS. 210 learners have active accounts. Average lab session: 42 minutes. Most accessed exercise: AI-assisted code completion challenge.",
   currentStatusAt:"03 Mar 2025, 08:00",
   riskStatement:"Lab environment costs scaling with user volume — currently within budget but full-cohort rollout (600 users) will require cost optimisation (spot instances, auto-shutdown).",
   status:'In Progress',priority:'High',health:'Green',risk:'Low',impact:'Hands-on AI experience for all learners; accelerates confidence and adoption',
   owner:'Cloud Infrastructure Lead',startDate:'2024-12-01',endDate:'2025-05-31',progress:70,
   tags:['lab','aws','hands-on'],
   links:['pj6','st9'],dependencies:['t7'],attachments:[],keyResult:'',
   comments:[]},

  // ── SUBTASKS ──────────────────────────────────────────────────────────────────
  {id:'st1',key:'ST-0001',type:'subtask',
   title:"Set up Grafana dashboards for Copilot pilot productivity metrics",
   description:"Create Grafana dashboards pulling from GitHub API and Jira — displaying PR throughput, review cycle time, build pass rate, and story point velocity per engineer and per squad.",
   currentStatus:"Dashboard live. 6 panels tracking all agreed KPIs. Automated daily refresh. Shared with CTO and pilot squad leads.",
   currentStatusAt:"17 Feb 2025, 16:30",
   riskStatement:"GitHub API rate limits may cause data gaps during peak working hours — rate limit monitoring alert configured.",
   status:'Completed',priority:'High',health:'Green',risk:'Low',impact:'Real-time visibility into pilot productivity metrics for all stakeholders',
   owner:'Data Engineer',startDate:'2025-02-10',endDate:'2025-02-17',progress:100,
   tags:['grafana','dashboard','metrics'],
   links:['t1'],dependencies:[],attachments:[{name:'Copilot Metrics Dashboard Design.pdf',size:'890 KB',ext:'pdf',uploadedAt:'2025-02-15'}],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st2',key:'ST-0002',type:'subtask',
   title:"Capture pre-pilot productivity baseline for all 100 pilot engineers",
   description:"Extract 4-week historical data from GitHub and Jira for all 100 pilot engineers to establish a pre-Copilot baseline for PR throughput, review time, and velocity.",
   currentStatus:"Baseline data exported and validated. Average pre-pilot PR throughput: 3.2 PRs/engineer/week. Average review time: 4.1 hours. Stored in data warehouse.",
   currentStatusAt:"14 Feb 2025, 15:00",
   riskStatement:"Historical Jira data quality is inconsistent for some squads — engineers who did not log story points have incomplete velocity records.",
   status:'Completed',priority:'High',health:'Green',risk:'Low',impact:'Authoritative pre-pilot baseline enabling rigorous impact measurement',
   owner:'Data Engineer',startDate:'2025-02-10',endDate:'2025-02-14',progress:100,
   tags:['baseline','data','measurement'],
   links:['t1'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st3',key:'ST-0003',type:'subtask',
   title:"Synthesise and distribute Week 3 pilot feedback report",
   description:"Collate qualitative feedback from Week 3 check-in sessions, categorise themes, score sentiment, and produce a structured weekly report for the Engineering Transformation Lead and CTO.",
   currentStatus:"Week 3 report distributed. Top insight: 91% of engineers find autocomplete valuable; 62% find test suggestion quality 'good or better'; strongest request is for prompt engineering guidance.",
   currentStatusAt:"03 Mar 2025, 09:00",
   riskStatement:"Feedback synthesis is subjective — risk of confirmation bias in report framing. Independent reviewer should spot-check summaries.",
   status:'Completed',priority:'Medium',health:'Green',risk:'Low',impact:'Actionable weekly intelligence on pilot progress for leadership',
   owner:'Engineering Transformation Lead',startDate:'2025-03-01',endDate:'2025-03-03',progress:100,
   tags:['feedback','report','pilot'],
   links:['t2'],dependencies:[],attachments:[{name:'Copilot Pilot Week 3 Report.pdf',size:'420 KB',ext:'pdf',uploadedAt:'2025-03-03'}],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st4',key:'ST-0004',type:'subtask',
   title:"Automate code-exclusion policy inheritance check for new repositories",
   description:"Write a GitHub Actions workflow that automatically checks any newly created repository against the exclusion policy list and raises a PR to apply the policy if missing.",
   currentStatus:"Workflow written and tested in staging. Deployed to GitHub Enterprise. 3 new repos created since deployment — all correctly auto-patched with policy.",
   currentStatusAt:"18 Feb 2025, 14:00",
   riskStatement:"Workflow depends on a naming convention for proprietary repos — if convention is not followed, automation may miss newly created repos.",
   status:'Completed',priority:'High',health:'Green',risk:'Low',impact:'Zero-gap security policy enforcement on all current and future repositories',
   owner:'Platform Security Lead',startDate:'2025-02-11',endDate:'2025-02-18',progress:100,
   tags:['automation','security','github-actions'],
   links:['t3'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[
     {id:'c11',text:'Workflow approved by Security Architect. Deployed to production GitHub Enterprise.',ts:'18 Feb 2025, 13:45'},
   ]},

  {id:'st5',key:'ST-0005',type:'subtask',
   title:"Document CodeRabbit configuration profiles and best practices guide",
   description:"Produce a configuration guide documenting the CodeRabbit profile settings for each squad type (frontend, backend, data, mobile), with recommended sensitivity levels and examples of good vs noisy feedback.",
   currentStatus:"Draft guide completed covering 12 configured squads. Peer-reviewed by 3 squad leads. Final version being formatted for internal wiki.",
   currentStatusAt:"02 Mar 2025, 14:00",
   riskStatement:"Guide may become outdated as CodeRabbit releases new features — needs a named owner committed to quarterly review.",
   status:'In Progress',priority:'Medium',health:'Green',risk:'Low',impact:'Faster squad onboarding to CodeRabbit; consistent configuration quality across all teams',
   owner:'DevEx Lead',startDate:'2025-02-15',endDate:'2025-03-14',progress:75,
   tags:['documentation','coderabbit','best-practices'],
   links:['t4'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st6',key:'ST-0006',type:'subtask',
   title:"Raise and track Diffblue support ticket for Python async test generation",
   description:"Formally document the Python async function test generation failure mode, reproduce with a minimal test case, and raise with Diffblue support. Track to resolution or workaround.",
   currentStatus:"Support ticket raised (DFB-8847). Diffblue confirmed as known issue — fix targeted in v2.4.1 (ETA: end March). Workaround documented: decorator-based async unwrapper applied.",
   currentStatusAt:"28 Feb 2025, 11:00",
   riskStatement:"If v2.4.1 is delayed, Python squads will be blocked on AI unit test generation for an extended period — manual test writing required as interim.",
   status:'In Progress',priority:'High',health:'Amber',risk:'Medium',impact:'Unblocks Python-heavy squads from AI unit test generation',
   owner:'QE Platform Lead',startDate:'2025-02-25',endDate:'2025-03-31',progress:50,
   tags:['diffblue','python','support'],
   links:['t5'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st7',key:'ST-0007',type:'subtask',
   title:"Complete Selenium-to-Testim migration for Checkout squad (340 scripts)",
   description:"Execute the full script migration from Selenium to Testim for the Checkout squad — converting all 340 test scripts, configuring self-healing parameters, and running a full regression validation pass.",
   currentStatus:"All 340 Checkout scripts migrated and validated. First full Testim regression run: 97.4% pass rate (vs 81% on final Selenium run). 9 scripts flagged for manual review due to dynamic element complexity.",
   currentStatusAt:"27 Feb 2025, 17:00",
   riskStatement:"9 flagged scripts involve the 3D Secure payment widget — Testim's element detection is unreliable for this component. Manual coverage required as fallback.",
   status:'Completed',priority:'High',health:'Green',risk:'Low',impact:'Checkout squad fully migrated to self-healing automation; 16.4% improvement in regression pass rate',
   owner:'Senior QE Engineer',startDate:'2025-02-01',endDate:'2025-02-28',progress:100,
   tags:['selenium','testim','checkout','migration'],
   links:['t6'],dependencies:[],attachments:[{name:'Checkout Migration Validation Report.pdf',size:'1.1 MB',ext:'pdf',uploadedAt:'2025-02-28'}],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st8',key:'ST-0008',type:'subtask',
   title:"Update AI Foundations Unit 2 — expand Responsible AI and hallucination content",
   description:"Revise and expand the Responsible AI unit based on learner feedback — adding a new section on AI hallucination risks, prompt injection vulnerabilities, and the organisation's AI acceptable use policy.",
   currentStatus:"Content draft complete. Legal and Compliance review in progress. Target: v1.1 published by 21 Mar 2025.",
   currentStatusAt:"03 Mar 2025, 07:45",
   riskStatement:"Legal and Compliance review cycle can take 2–3 weeks — if delayed, the update may miss the next cohort intake on 01 Apr.",
   status:'In Progress',priority:'Medium',health:'Amber',risk:'Medium',impact:'More comprehensive Responsible AI literacy for all 600 learners',
   owner:'L&D Content Lead',startDate:'2025-02-24',endDate:'2025-03-21',progress:55,
   tags:['content-update','responsible-ai','hallucination'],
   links:['t7'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},

  {id:'st9',key:'ST-0009',type:'subtask',
   title:"Optimise lab environment cost for scale (spot instances + auto-shutdown)",
   description:"Implement AWS spot instance configuration and auto-shutdown policies for the AI Academy lab environment to reduce cost per learner-hour by 40% ahead of full-cohort rollout.",
   currentStatus:"Spot instance migration completed for 80% of lab workloads. Auto-shutdown (30-min idle) deployed. Estimated cost reduction: 38% per learner-hour vs on-demand baseline.",
   currentStatusAt:"03 Mar 2025, 08:00",
   riskStatement:"Spot instance interruptions (average 5% frequency) may disrupt active lab sessions. Checkpoint-and-resume capability needs to be implemented before full rollout.",
   status:'In Progress',priority:'Medium',health:'Amber',risk:'Medium',impact:'Lab environment cost-optimised and ready to scale from 210 to 600 concurrent learners',
   owner:'Cloud Infrastructure Lead',startDate:'2025-02-15',endDate:'2025-03-31',progress:65,
   tags:['aws','cost-optimisation','lab-infrastructure'],
   links:['t8'],dependencies:[],attachments:[],keyResult:'',
   impactType:'',assigned:'',sponsor:'',businessUnit:'',approvedBudget:'',actualCost:'',updatedAt:'03 Mar 2025, 10:00',updatedBy:'RB',
   comments:[]},
];
...
const FIELD_DEFS=[
  ...
  {k:'endDate',l:'Due Date'},{k:'owner',l:'Owner'},{k:'tags',l:'Tags'},
];
// All fields on by default (status now included)
const ALL_VIS_FIELDS=new Set(FIELD_DEFS.map(f=>f.k));
const DEFAULT_VIS_FIELDS=ALL_VIS_FIELDS;
...
function KCard({item,selected,isDragging,onClick,onDragStart,onDragEnd,visFields}){
  ...
  return(
    <div draggable onDragStart={onDragStart} onDragEnd={onDragEnd} onClick={onClick}
      ...
      {/* Status pill — shown directly below title */}
      {vf.has('status')&&(
      ...
      {vf.has('currentStatus')&&item.currentStatus&&<div className="text-gray-500 mb-1.5 leading-snug" style={{fontSize:11,borderLeft:'2px solid #d1d5db',paddingLeft:6}}>{item.currentStatus.slice(0,60)}{item.currentStatus.length>60?'…':''}</div>}
      ...
      {vf.has('owner')&&item.owner&&<div className="text-gray-500 mb-1.5" style={{fontSize:11}}>👤 {item.owner}</div>}
      {vf.has('tags')&&item.tags?.length>0&&<div className="flex gap-1 mt-1 flex-wrap">{item.tags.slice(0,2).map(t=><span key={t} className="bg-gray-100 text-gray-500 rounded px-1.5 py-0.5" style={{fontSize:10}}>{t}</span>)}{item.tags.length>2&&<span className="text-gray-400" style={{fontSize:10}}>+{item.tags.length-2}</span>}</div>}
    </div>
  );
}
